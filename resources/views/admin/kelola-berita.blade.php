...
<div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
    ...
    <div class="flex justify-between items-center px-6 py-5">
        ...
        <div class="relative flex items-center">
            ...
            <input type="text" placeholder="Cari artikel..." style="padding-left: 36px;"
    ...
    <table class="w-full text-left text-sm">
        <thead>
            <tr class="text-gray-500 border-y border-gray-100 bg-gray-50 uppercase text-xs">
                ...
                <th class="px-6 py-3 whitespace-nowrap">Tanggal Publikasi</th>
                ...
                <tr class="border-b border-gray-50">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2">
                            ...
                            {{-- Lihat --}}
                            <a href="{{ route('admin.berita.show-admin', $b->id) }}"
