    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden h-fit">
            ...
            <div class="px-6 pb-6 -mt-10 text-center">
                ...
                <form method="POST" action="{{ route('logout') }}" class="mt-5">
                    @csrf
                    <button type="submit"
                        class="w-full flex items-center justify-center gap-2 text-red-600 bg-red-50 hover:bg-red-100 py-2.5 rounded-lg text-sm font-medium">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <button type="button" onclick="document.getElementById('riwayatBox').classList.toggle('hidden'); this.querySelector('svg').classList.toggle('rotate-90')"
            ...
            {{-- Settings (accordion) — Ganti Password & Hapus Akun bawaan Breeze --}}
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <button type="button" onclick="document.getElementById('settingsBox').classList.toggle('hidden'); this.querySelector('svg').classList.toggle('rotate-90')"
                    class="w-full flex items-center justify-between px-6 py-4 text-left">
                    <span class="font-medium text-gray-800 flex items-center gap-2">
